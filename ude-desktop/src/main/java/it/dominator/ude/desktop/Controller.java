...
public class Controller {
    ...
    final private MenuItem settingsMenuItm = new MenuItem("it.dominator.ude.desktop.Settings"),
    ...
    void addIconTiles() {
            ...
            // Create it.dominator.ude.desktop.Icon and position icon on grid according to parameters
