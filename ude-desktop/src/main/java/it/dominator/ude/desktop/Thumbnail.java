package it.dominator.ude.desktop;// Generates the actual image of the icon.
        ...
        if (temp.matches("^.*?(avi|webm|mpeg|mpg|mkv|flv|wmv|mp4).*$")) {
            ...
            try {
                ...
                while(scanner.hasNext()) {
                    ...
                    if(line.contains("it.dominator.ude.desktop.Icon=")) {
                        thumbImg = line;
                        break;
                    }
                }
            } catch(Throwable lineErr) {
                 System.out.println("Failed To Get it.dominator.ude.desktop.Icon: " + lineErr);
            }
            thumbImg = thumbImg.replaceAll("Icon=","");  // Strip it.dominator.ude.desktop.Icon= from the icon info
            ...
            // } catch (Throwable e) {
            //     System.out.println("Exception Caught In it.dominator.ude.desktop.Thumbnail.\n" + e);
            // }
            // thumbImg = shellOut;
