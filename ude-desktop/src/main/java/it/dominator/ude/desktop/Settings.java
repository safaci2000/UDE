package it.dominator.ude.desktop;// ::  NOTES  ::
//  Read file for it.dominator.ude.desktop.Icon= to get the desktop's icon. Then look for it in:
...
public class Settings {
    ...
    private Settings() {
        ...
        settingsStage.setTitle("it.dominator.ude.desktop.Settings");
